    ...
    private function captions(): array
    {
        ...
        return [
            ...
            [$ru, SocialPillar::BehindTheScenes, SocialCtaType::WhatsappOrder,
                'Pakistan mein online shopping ka sab se bara darr: paisa pehle, maal baad mein. Isi liye hum sirf Cash on Delivery karte hain — maal haath mein aaye, tab paisa dein. Order WhatsApp par: 0301 2973886'],
            ...
            [$ru, SocialPillar::BehindTheScenes, SocialCtaType::None,
                'Neem ka istemal jild ki dekhbhal mein sadiyon purana hai. Acne-prone jild wale aksar neem sabun pasand karte hain. Hum jald neem soap stock karne wale hain — kis size mein chahiye, batayein?'],
            [$en, SocialPillar::CustomerQa, SocialCtaType::None,
            ...
            [$ru, SocialPillar::BehindTheScenes, SocialCtaType::WhatsappOrder,
                'Lookman-e-Hayat Herbal Oil: 50ml Rs 1,200 · 100ml Rs 2,200. Til 97% + guggul 3%. Maalish aur rozana jild ki dekhbhal ke liye. Poore Pakistan COD, 7 din return. WhatsApp: 0301 2973886'],
            [$en, SocialPillar::BehindTheScenes, SocialCtaType::None,
            ...
            [$en, SocialPillar::SeasonalSkincare, SocialCtaType::None,
                'Karachi humidity + sweat + sunscreen = clogged skin. Light oils after washing at night (not before going out) is how oil-users manage it. Heavy greasy layers in this weather? Skip them.'],
            [$ru, SocialPillar::BehindTheScenes, SocialCtaType::None,
            ...
            [$en, SocialPillar::BehindTheScenes, SocialCtaType::WhatsappOrder,
                'How ordering works: WhatsApp us → we confirm by SMS → courier arrives in 2-4 working days (Karachi/Lahore/Islamabad) → you pay cash at the door. Rs 300 delivery, free over Rs 5,000. Simple. 0301 2973886'],
            [$ru, SocialPillar::HowTo, SocialCtaType::None,
